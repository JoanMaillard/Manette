...
void receiver_function(uint8_t *payload, uint16_t length, const PJON_Packet_Info &packet_info) {
  ...
  if (val_bouton5 != payload[8]) {
    val_bouton5 = payload[8];
    change_bou5 = true;
  }
...
void loop() {
  ...
  // Show the new value of the button 5
  if (change_bou5) {
    change_bou5 = !change_bou5;
    Serial.print("Bouton 5: ");
    Serial.println(val_bouton5);
  }
#endif
}
