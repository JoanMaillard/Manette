    ...
    switch (communicationProtocol.getLastPacketID())
    {
      ...
      case 0: // Game
        ...
        if (received == "Pause") {
          ...
          Wire.beginTransmission(8); // On commande la communication avec l'Arduino #3 (Moteurs)
      ...
      case 2: // Motors
        ...
        Wire.beginTransmission(19); // On commande la communication avec l'Arduino #3 (Moteurs)
        Wire.write(posXByte, 2); // On lui envoie la position X
        Wire.write(posYByte, 2); // On lui envoie la position Y
        Wire.endTransmission(); // On arrête la transmission*/
        /*Serial.print("posXByte[0]: ");
          Serial.print(posXByte[0]);
          Serial.print(" et posXByte[1]: ");
          Serial.println(posXByte[1]);
          Serial.print("posYByte[0]: ");
          Serial.print(posYByte[0]);
          Serial.print(" et posYByte[1]: ");
          Serial.println(posYByte[1]); */
        Serial.println();
        break;
      case 4: // Head
